using HZSoft.CodeGenerator.Comm;
...
namespace HZSoft.CodeGenerator.Template
{
    /// <summary>
    /// 版 本 6.1
    /// 
    ...
    public class SingleTable
    {
        ...
        public string EntityBuilder(BaseConfigModel baseConfigModel, DataTable dt)
        {
            ...
            sb.Append("using HZSoft.Application.Code;\r\n\r\n");

            sb.Append("namespace HZSoft.Application.Entity." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本\r\n");
            sb.Append("    /// \r\n");
        ...
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using HZSoft.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using System.Data.Entity.ModelConfiguration;\r\n\r\n");

            sb.Append("namespace HZSoft.Application.Mapping." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本\r\n");
            sb.Append("    /// \r\n");
        ...
        public string ServiceBuilder(BaseConfigModel baseConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using HZSoft.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HZSoft.Application.IService." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HZSoft.Data.Repository;\r\n");
            sb.Append("using HZSoft.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System.Linq;\r\n\r\n");

            sb.Append("namespace HZSoft.Application.Service." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// \r\n");
        ...
        public string IServiceBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("namespace HZSoft.Application.IService." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// \r\n");
        ...
        public string BusinesBuilder(BaseConfigModel baseConfigModel)
        {
            ...
            sb.Append("using HZSoft.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HZSoft.Application.IService." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HZSoft.Application.Service." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HZSoft.Util.WebControl;\r\n");
            sb.Append("using System.Collections.Generic;\r\n");
            sb.Append("using System;\r\n\r\n");

            sb.Append("namespace HZSoft.Application.Busines." + baseConfigModel.OutputAreas + "\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// \r\n");
        ...
        public string ControllerBuilder(BaseConfigModel baseConfigModel)
        {
            StringBuilder sb = new StringBuilder();
            sb.Append("using HZSoft.Application.Entity." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HZSoft.Application.Busines." + baseConfigModel.OutputAreas + ";\r\n");
            sb.Append("using HZSoft.Util;\r\n");
            sb.Append("using HZSoft.Util.WebControl;\r\n");
            sb.Append("using System.Web.Mvc;\r\n\r\n");

            sb.Append("namespace HZSoft.Application.Web.Areas." + baseConfigModel.OutputAreas + ".Controllers\r\n");
            sb.Append("{\r\n");
            sb.Append("    /// <summary>\r\n");
            sb.Append("    /// 版 本 6.1\r\n");
            sb.Append("    /// \r\n");
